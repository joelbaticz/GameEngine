...
void Label::Init(Node* parent, std::string name, std::string text, int x, int y, int width, int height)
{
	...
	//Texture* backgroundTexture = AssetManager::CreateTexture("Button.png");
...
Label::Label(Node* parent, std::string name, std::string text, int x, int y, int width, int height)
{
	LogEngine::Log(LOG_TRACE, "Label", "Constructor called.");
